...
('Sarammal', 'sarammalbca2003@gmail.com', '$2a$12$R9h7cIPz0gi.URNNX3kh2OPST9/PgBkqquzi.Pf97fh', '7755632012', 'ADMIN', TRUE),
('Ashish Kumar', 'test34@gmail.com', '$2a$12$KL9n/h6Gvd7Ks2w1.XfVe1Jc8Vz3YrRh5QpMnWtVxD', '8565452152', 'ADMIN', TRUE),
('Tino', 'tino@example.com', '$2a$12$KIX5J8qQF1JQ6H8KfP1B5uZqlB2VtEJQbzCh0cZQyL8y0GvO3bL6O', '9876543210', 'ADMIN', TRUE);

-- Insert Users (Customers)
INSERT INTO `users` (name, email, password, phone, role, gender, address, city, pincode, state, is_active) VALUES
('Anirudh Kumar', 'test786@gmail.com', '$2a$12$R9h7cIPz0gi.URNNX3kh2OPST9/PgBkqquzi.Pf97fh', '7546254260', 'CUSTOMER', 'Male', 'KN nagar', 'Patna', '401980', 'Bihar', TRUE),
('Amit', 'amt677@gmail.com', '$2a$12$KL9n/h6Gvd7Ks2w1.XfVe1Jc8Vz3YrRh5QpMnWtVxD', '8563201201', 'CUSTOMER', 'Male', 'AJ', 'Banglore', '865012', 'Karnataka', TRUE);
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT fk_cart_user FOREIGN KEY (`uid`) REFERENCES `users`(`id`),
...
CREATE TABLE `wishlist` (
  ...
  CONSTRAINT fk_wishlist_user FOREIGN KEY (`iduser`) REFERENCES `users`(`id`),
  CONSTRAINT fk_wishlist_product FOREIGN KEY (`idproduct`) REFERENCES `product`(`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Set correct foreign key checks
